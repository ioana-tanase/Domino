        ...
        <div class="container">
            <div class="col-xs-12">
                <div class="col1" width="1000">
                    ...
                    <a href = "bugtracker.php" class="focus pull-left">BUGTRACKER</a>
                    <p>&nbsp;</p>
                    <hr>
                    <div id="welcomeDiv" class="">
                        <form action="game.php" method="GET">
                            <div>
                                <label class="label label-primary">PLAYER 1:</label> <input type="text" name="Player1Name" required>
                            </div>
                            <div>
                                <label class="label label-primary">PLAYER 2:</label> <input type="text" name="Player2Name" required>
                            </div>
                            <button name="option" type="submit" class="btn btn-primary" value="play">PLAY!</button>
                            <button name="option" type="submit" class="btn btn-primary" value="load">LOAD!</button>
                        </form>
                    </div>
                    <hr>
                    <p>&nbsp;</p>
