		...
		<div class="container">
			<div class="col-xs-12">
				<div class="col1" width="1000">
					<a href = "index.php" class="pull-left">NEWS</a>
					<a href = "devlogs.php" class="focus pull-left">DEVLOGS</a>
					<a href = "bugtracker.php" class="pull-left">BUGTRACKER</a>
					<p>&nbsp;</p>
					<hr>
					<h1 itemprop="name">DominoX</h1>
						<p>Play mode: <span itemprop="playMode"> MultiPlayer (2 players) </span></p>
						<p>Genre: <span itemprop="genre">Tile-based game</span></p>
						<p>Game Platforms: </p>
					<ul>
						<li itemprop="gamePlatform"> Microsoft Windows X </li>
						<li itemprop="gamePlatform">Mobile Platforms</li>
					</ul>
						<p>Created by:</p>
							<section itemscope itemtype="http://schema.org/Person"> 
							<ul>
								<li><span itemprop="name">Ioana Tanase</span></li>
								<li><span itemprop="name">Alis Andriescu</span></li>
							</ul>
						<p> Occupation: </p>
							<ul>
								<li><span itemprop="jobTitle">students</span> 
								at the 
								<span itemprop="affiliation">Faculty of Computer Science</span> 
								</li>
							</ul>
					<hr>
					<p>&nbsp;</p>
